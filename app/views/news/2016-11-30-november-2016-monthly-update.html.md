...
We had three improvements with our meta tooling this month. The [how_is](https://github.com/how-is/how_is) tool got another [release](https://github.com/how-is/how_is/blob/v11.0.0/CHANGELOG.md#1100), and will soon be used to actively [appraise the status](https://how-is.github.io/how-is-rubygems/2016/12/01/report.html) of our various projects.

We also created a [time-card](https://github.com/rubytogether/rubytogether-lita/blob/84f6bec5d2faabbcb914132cd2880b8e7bacf33e/lib/lita/handlers/time_card.rb) handler for the [lita](https://www.lita.io/) bot, soon to be available for use in a chat room near you!

Finally, we shipped a new merge-bot: [@bundlerbot](https://github.com/bundlerbot). We've been using the [homu.io](http://homu.io) service for over a year, but a long-standing bug prevented us from managing team member permissions. Now we have [our own copy of homu](https://bundlerbot-homu.herokuapp.com), and we look forward to updating team members and merging only green code for years to come.
